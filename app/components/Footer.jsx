    ...
    <div className='mt-20'>
      <div className='text-center'>
        ...
        <div className='w-max flex items-center gap-2 mx-auto'>
            ...
            tanvimalaviya10@gmail.com
        </div>
         
      </div>
      <div className='text-center sm:flex items-center justify-between border-top border-gray-400 mx-[10%] mt-12 py-6'>
            <p>@ 2025 willium MArk.All rights reserved.</p>
            <ul className='flex items-center gap-10 justify-center mt-4 sm:mt-0'>
                <li><a target='_blank' href='https://github.com/tanvimalaviya/'>Github</a></li>
                <li><a target='_blank' href='https://github.com/tanvimalaviya/'>Instragram</a></li>
                <li><a target='_blank' href='https://github.com/tanvimalaviya/'>Linkdin</a></li>
            </ul>
      </div>
    </div>
  )
