    ...
    transition={{duration:1}}
     id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
       ...
       className='text-center mb-2 text-lg font-Ovo'>What I Offer</motion.h4>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'> I am a frontend developer from cslifornia,USA with 10 years of experience in multiple companies like microsoft,tesla & amazon</motion.p>
        <motion.div 
         initial={{opacity:0}}
         whileInView={{opacity:1}}
