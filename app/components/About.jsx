...
const About = ({isDarkMode,setIsDarkMode}) => {
  return (
    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center text-5xl font-Ovo'>About me</motion.h1>
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='w-64 sm:w-80 rounded-3xl    max-w-none'>
                <Image src={assets.user_image} className='w-full rounded-3xl' alt='user'></Image>
            </motion.div>
            <motion.div
            initial={{opacity:0 }}
            whileInView={{opacity:1 }}
            ...
            className='flex-1'>
               <p className='mb-10 max-w-2xl font-Ovo'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime, laborum quos corporis neque aperiam ratione vitae, eius est magnam, perspiciatis excepturi sapiente possimus odit obcaecati nobis. Non in consequuntur eos placeat suscipit! Tenetur et quo harum magni nobis ipsam dolor.</p> 
               <motion.ul
               initial={{opacity:0 }}
               whileInView={{opacity:1}}
               ...
               <h4 className='my-4 font-Ovo text-gray-700 dark:text-white/80'>Tools I Use</h4>
